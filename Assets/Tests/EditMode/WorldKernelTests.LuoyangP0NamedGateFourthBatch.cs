...
namespace Mandate.Tests
{
    ...
    {
        [Test]
        public void LuoyangP0NamedGateFourthBatch_FreezesFourAcceptedActivatedSlots()
        {
            ...
            var batch = new LuoyangP0NamedGateFourthBatchSource(root,
                coverage.CombinedCatalog, gates, review);
            ...
            Assert.That(batch.Catalog.ReviewDecisionStatusId, Is.EqualTo(
