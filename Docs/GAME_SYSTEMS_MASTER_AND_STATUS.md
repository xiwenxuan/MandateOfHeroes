...
| [`HISTORICAL_POPULATION_135_260.md`](HISTORICAL_POPULATION_135_260.md) | 135—260逐年人口、史料锚点、历史档和空间分布方法 |
...
| 永久人口 | 已有底座（M14村庄切片） | 200—500人村庄已验证出生即永久ID；全国规模仍待M15存储与调度证据 |
| 分级模拟 | 已定方案 | 基础人口、活跃人口、历史留名、重要人物和关注人物 |
| 关注与演出 | 已定方案 | 关注影响信息和表现，不决定人物是否存在 |
| 确定性模拟 | 已有底座 | 稳定随机、领域事件、日志和快速模拟 |
| 超大人口存储 | 待研究 | SQLite、分区二进制或混合存储 |
| MOD与版本迁移 | 已有底座 | 稳定ID、数据版本、存档迁移和MOD边界 |

标准性能档目标为5,000万人，157年前后的历史档允许约5,650万人。
在压力测试达标前，不得宣称已经支持这些规模。
...
| 具体农业 | 已定方案 | 水稻、小麦、粟黍、豆类、桑园、果园和药圃 |
...
| 科研科技 | 已定方案 | 五领域科技卡、人才、资源、周期和局部应用 |
| 原住民科研 | 已定方案 | 实践、师徒、家学、典籍、官府工程和异地技术 |
...
这些内容必须建立在永久人口、生产、物流、科研、组织和历史事件底座之上。
...
汇总缓存。后续必须设计存档迁移，不能直接把旧批次方案扩大到数千万人。

### 0D.2 超大存档

当前小世界快照不能直接承担5,000万至5,650万人。需要先比较SQLite、分区二进制和
混合方案，再进行10万、100万、1,000万、5,000万和5,650万人测试。
...
科研已确定为科技卡、负责人、资源、周期、结果、应用和传播，目前仍属于设计方案。
...
M14已经完成200—500人的真实村庄与家庭生活闭环。当前从尚未完成的依赖继续：

1. 按[`TASK_M15_PERMANENT_POPULATION_STORAGE_BENCHMARK.md`](TASK_M15_PERMANENT_POPULATION_STORAGE_BENCHMARK.md)
   回补M12永久人物存储与调度压力原型，直接消费M13的105项人口来源与稳定地理权重；
2. 实现具体农业、仓储和第一条生产链；
3. 实现首批科技卡及其局部应用；
4. 实现关注系统和局部关系网络；
5. 扩大到一县的财政、豪族、市场和基层治理；
6. 完成人物装备、军械库与兵种派生；
7. 扩大到州郡经济、迁徙、军需和战争；
8. 完成1,000万、5,000万和5,650万人压力验收；
9. 接入135—260完整历史数据；
10. 最后建设穿越者框架和大型意难平MOD。
