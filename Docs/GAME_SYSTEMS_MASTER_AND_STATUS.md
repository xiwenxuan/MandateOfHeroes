...
| MOD与版本迁移 | 已有底座 | 稳定ID、V1至V14顺序迁移、V6内联人口无损进入V7共存模式、V8—V10生产科研扩展、V11关注账、V12县级治理账、V13军械账、V14军械采购运输账和MOD边界 |
...
| 仓储与物流 | 已有底座（M19-P0、M23-P0，待扩展） | 产品/种子批次、通用库存事务、旧粮账转换、组织商队容器、人物随行运输和军械批次迁移已建立；多段寻路、腐败、拆分合并和通用货运待扩展 |
...
| 装备与军械库 | 已有原型（M11、M23-P0） | V14六种数据驱动军械产品、三军库存、真实发放、齐整度、损坏、遗失、缴获、采购入库与守恒审计 |
| 军械采购与运输 | 已有原型（M23-P0） | 有军权人物从组织军费付款，商号成品批次由永久承运人沿真实路线运输，与目标军队会合后一次入库；制造配方、押运战斗和完整后勤网待扩展 |
...
1. 继续扩大州郡经济、迁徙、军需和战争：在已完成采购运输闭环上补齐冶铁、木作、
   制弓和制甲配方、修理、押运风险、多段物流与军需委任；
