...
- M1至M12任务书记录阶段目标和实现历史，编号不自动表示当前优先级；
...
2. 建立200—500人的真实村庄和家庭生活闭环；
3. 实现具体农业、仓储和第一条生产链；
4. 实现首批科技卡及其局部应用；
5. 实现关注系统和局部关系网络；
6. 扩大到一县的财政、豪族、市场和基层治理；
7. 完成人物装备、军械库与兵种派生；
8. 扩大到州郡经济、迁徙、军需和战争；
9. 完成1,000万、5,000万和5,650万人压力验收；
10. 接入135—260完整历史数据；
11. 最后建设穿越者框架和大型意难平MOD。
