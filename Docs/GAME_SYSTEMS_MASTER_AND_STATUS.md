...
| 永久人口 | 已有底座（M14村庄切片、M15-P6、M20-P0） | 200—500人生活闭环、累计1000万冷热档案、5000万全部在世基础调度证据、V7正式分区人口包共存适配器，以及关注热计划与安全降温协调；未驻留人口尚未从`WorldState.People`移出 |
...
1. 在扩大人口前逐步建立模拟系统的人物仓储访问层和增量变更检查点；
