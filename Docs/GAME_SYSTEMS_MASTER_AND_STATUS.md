...
| MOD与版本迁移 | 已有底座 | 稳定ID、V1至V13顺序迁移、V6内联人口无损进入V7共存模式、V8—V10生产科研扩展、V11关注账、V12县级治理账、V13军械账和MOD边界 |
...
| 装备与军械库 | 已有原型（M11） | V13六种数据定义、三军库存、真实发放、齐整度、损坏、遗失、缴获与守恒审计 |
...
装备、三军军械库、兵种派生、战备修正和战后军械回写原型。后续全局顺序为：

1. 扩大到州郡经济、迁徙、军需和战争，优先打通军械生产、采购、运输和入库供应链；
