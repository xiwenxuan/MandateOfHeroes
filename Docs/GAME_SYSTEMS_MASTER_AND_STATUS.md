...
| 永久人口 | 已有底座（M14村庄切片、M15-P6、M20-P0、M21-P0/P1/P2/P3/P4/P5/P6） | 200—500人生活闭环、累计1000万冷热档案、5000万全部在世基础调度证据、V7正式分区人口包、关注热计划、人物仓储访问合同、出生增量及村庄人口台账、农业、教育、军医康复与军事核心人物访问迁移；未驻留人口尚未从`WorldState.People`移出 |
...
| 超大人口存储 | 已有底座与实验（M15-P6、M21-P0/P1/P2/P3/P4/P5/P6） | 正式程序集已有稳定分区、完整代际、区分出生新增与既有人物修改的增量检查点、清单校验和冷热扩展合同；旅行、关系、任务、生命家庭、村庄生活、人口台账、农业生产、教育、军医康复与军事核心路径已开始使用人物访问层；完整运行时外置与游戏负载仍未完成 |
| MOD与版本迁移 | 已有底座 | 稳定ID、V1至V16顺序迁移、V6内联人口无损进入V7共存模式、V8—V10生产科研扩展、V11关注账、V12县级治理账、V13军械账、V14军械采购运输账、V15工坊制造维修账、V16资源采集账和MOD边界 |
...
| 资源采集与初级加工 | 已有原型（M23-P2） | 中山铁矿体与林地保存来源、规则版本、储量、预留、品位和难度；真实组织人物通过耗时采集工单取得矿石与木料，并可烧炭、块炼铁；完整资源创世、勘探、多矿脉、事故与林木再生待扩展 |
| 加工制造 | 已有底座（M19-P0、M23-P1/P2） | 家庭粮仓与组织工坊共用批次预留、耗时、结算和库存流水；已打通粮食加工、木炭/块炼铁及六类军械制造配方，制革、品质、技能成长和更多产业待扩展 |
| 多年生资产 | 已定方案 | 桑园、果园、林场的成长、成熟和毁坏 |
| 产业链 | 已定方案 | 农田—仓储、桑园—丝织、铁矿—铁器、药圃—医馆 |
| 市场和商旅 | 已有原型（基础，M22-P0县级反馈） | 商品、供需、价格、采购、运输和销售；县级粮价压力已能反馈救济和治安 |
| 仓储与物流 | 已有底座（M19-P0、M23-P0/P1，待扩展） | 产品/种子批次、通用库存事务、旧粮账转换、组织静态仓与商队容器、人物随行运输和军械批次迁移已建立；多段寻路、腐败、拆分合并和通用货运待扩展 |
...
| 军械采购与运输 | 已有原型（M23-P0/P1） | 有军权人物从组织军费付款，商号工坊成品可从静态仓装入永久承运人的商队，沿真实路线与目标军队会合后一次入库；押运战斗、多段物流和完整后勤网待扩展 |
...
固定`CropKind`技术债已经移除。当前仍保留尚未转换的家庭单一粮食余额和农业专用账本，
收获自动批次化、多仓库运输、腐败品质、市场成交与消费/军需迁移尚未完成；后续必须沿
数据定义和批次事务合同扩展，不能重新引入固定作物枚举。
...
1. 继续扩大州郡经济、迁徙、军需和战争：在已完成林矿采集—冶炼—制造—采购—入库—维修
   闭环上接入畜牧、屠宰、制革和角料副产物，并补齐品质、工匠成长、押运风险、多段物流与军需委任；
2. 完成1,000万和累计5,000万永久人物完整游戏负载验收；
3. 建设223年第一个正式历史主题剧本，完成托孤后季汉世界状态、条件式历史事件、
   多身份参与和玩家完全不参与时的自主推进；
4. 223年剧本验收后，再评估184年等其他开局与135—260完整历史数据接入；这些内容
   当前滞后，不与223年并行争夺内容建设资源；
5. 穿越者框架和大型意难平MOD继续滞后，只保留接口兼容与设计记录，不进入近期开发。
