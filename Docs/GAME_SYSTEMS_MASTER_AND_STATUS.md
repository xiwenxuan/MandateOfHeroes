...
| 永久人口 | 已有底座（M14村庄切片、M15-P6、M20-P0、M21-P0/P1/P2/P3/P4） | 200—500人生活闭环、累计1000万冷热档案、5000万全部在世基础调度证据、V7正式分区人口包、关注热计划、人物仓储访问合同、出生增量及村庄人口台账、农业与教育人物访问迁移；未驻留人口尚未从`WorldState.People`移出 |
...
| 超大人口存储 | 已有底座与实验（M15-P6、M21-P0/P1/P2/P3/P4） | 正式程序集已有稳定分区、完整代际、区分出生新增与既有人物修改的增量检查点、清单校验和冷热扩展合同；旅行、关系、任务、生命家庭、村庄生活、人口台账、农业生产与教育已开始使用人物访问层；完整运行时外置与游戏负载仍未完成 |
...
汇总缓存。M15-P6已建立V7共存迁移和正式分区人口包，M21-P0/P1/P2/P3/P4已建立统一人物仓储
访问合同，并迁移旅行、关系、任务、生命家庭、村庄生活、人口台账、农业生产与教育人物访问。其余模拟系统仍有大量直接访问
...
触发底座。M21-P0/P1/P2/P3/P4已经完成人物仓储访问合同、旅行/关系/任务/生命家庭/村庄生活/
人口台账/农业生产/教育迁移、按分区增量检查点和出生人物增量写入。
当前从尚未完成的依赖继续：

1. 继续把医疗和军事等模拟系统分批迁移到人物仓储访问层；
