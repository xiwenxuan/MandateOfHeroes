...
| MOD与版本迁移 | 已有底座 | 稳定ID、V1至V17顺序迁移、V6内联人口无损进入V7共存模式、V8—V10生产科研扩展、V11关注账、V12县级治理账、V13军械账、V14军械采购运输账、V15工坊制造维修账、V16资源采集账、V17畜牧内容清单和MOD边界 |
...
| 加工制造 | 已有底座（M19-P0、M23-P1/P2/P3） | 家庭粮仓与组织工坊共用批次预留、耗时、结算和库存流水；已打通粮食加工、木炭/块炼铁、羊群繁育、屠宰、制革、角料与六类军械制造配方；多维品质、技能成长和更多产业待扩展 |
...
1. 继续扩大州郡经济、迁徙、军需和战争：在已完成林矿/畜牧采集—加工—制造—采购—入库—维修
   闭环上补齐多维品质与工匠成长，再接入押运风险、多段物流与军需委任；
