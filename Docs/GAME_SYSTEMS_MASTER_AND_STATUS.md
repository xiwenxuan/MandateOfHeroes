...
| MOD与版本迁移 | 已有底座 | 稳定ID、V1至V12顺序迁移、V6内联人口无损进入V7共存模式、V8—V10生产科研扩展、V11关注账、V12县级治理账和MOD边界 |
...
M22-P0已完成一县财政、豪族、市场和基层治理的守恒账底座。后续全局顺序为：

1. 完成人物装备、军械库与兵种派生；
2. 扩大到州郡经济、迁徙、军需和战争；
3. 完成1,000万和累计5,000万永久人物完整游戏负载验收；
