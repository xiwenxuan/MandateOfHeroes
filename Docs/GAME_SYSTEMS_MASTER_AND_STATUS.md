...
| 永久人口 | 已有底座（M14村庄切片、M15-P6、M20-P0、M21-P0/P1/P2/P3/P4/P5） | 200—500人生活闭环、累计1000万冷热档案、5000万全部在世基础调度证据、V7正式分区人口包、关注热计划、人物仓储访问合同、出生增量及村庄人口台账、农业、教育与军医康复人物访问迁移；未驻留人口尚未从`WorldState.People`移出 |
...
| 超大人口存储 | 已有底座与实验（M15-P6、M21-P0/P1/P2/P3/P4/P5） | 正式程序集已有稳定分区、完整代际、区分出生新增与既有人物修改的增量检查点、清单校验和冷热扩展合同；旅行、关系、任务、生命家庭、村庄生活、人口台账、农业生产、教育与军医康复已开始使用人物访问层；完整运行时外置与游戏负载仍未完成 |
| MOD与版本迁移 | 已有底座 | 稳定ID、V1至V11顺序迁移、V6内联人口无损进入V7共存模式、V8—V10生产科研扩展、V11关注账和MOD边界 |
...
| 加工制造 | 已有底座（M19-P0） | 已打通麦粒—面粉/麸皮—干粮的首条批次加工链；磨坊建设、冶铁、铁器、缫丝、织造、药坊和造船待扩展 |
| 多年生资产 | 已定方案 | 桑园、果园、林场的成长、成熟和毁坏 |
| 产业链 | 已定方案 | 农田—仓储、桑园—丝织、铁矿—铁器、药圃—医馆 |
| 市场和商旅 | 已有原型（基础） | 商品、供需、价格、采购、运输和销售 |
| 仓储与物流 | 已有底座（M19-P0，待扩展） | 产品/种子批次、通用库存事务、旧粮账转换、仓储容量兼容已建立；运输、腐败、拆分合并和军需迁移待扩展 |
...
汇总缓存。M15-P6已建立V7共存迁移和正式分区人口包，M21-P0/P1/P2/P3/P4/P5已建立统一人物仓储
访问合同，并迁移旅行、关系、任务、生命家庭、村庄生活、人口台账、农业生产、教育与军医康复人物访问。其余模拟系统仍有大量直接访问
...
触发底座。M21-P0/P1/P2/P3/P4/P5已经完成人物仓储访问合同、旅行/关系/任务/生命家庭/村庄生活/
人口台账/农业生产/教育/军医康复迁移、按分区增量检查点和出生人物增量写入。
当前从尚未完成的依赖继续：

1. 继续把战斗伤亡、逃亡、征募、行军等军事人物路径分批迁移到人物仓储访问层；
2. 扩大到一县的财政、豪族、市场和基层治理；
3. 完成人物装备、军械库与兵种派生；
4. 扩大到州郡经济、迁徙、军需和战争；
5. 完成1,000万和累计5,000万永久人物完整游戏负载验收；
6. 建设223年第一个正式历史主题剧本，完成托孤后季汉世界状态、条件式历史事件、
   多身份参与和玩家完全不参与时的自主推进；
7. 223年剧本验收后，再评估184年等其他开局与135—260完整历史数据接入；这些内容
    当前滞后，不与223年并行争夺内容建设资源；
8. 穿越者框架和大型意难平MOD继续滞后，只保留接口兼容与设计记录，不进入近期开发。
