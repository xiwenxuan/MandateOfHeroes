# 合肥 Development Reference Manifest

## Document Governance

- Purpose：为合肥后续开发提供唯一资料入口。
...
| Field | Frozen value |
|---|---|
| CanonicalPlaceId | `place.han140.yangzhou.jiujiang.hefei` |
| DevelopmentDepth | D4 |
| DevelopmentPriority | P1 |
| RecommendedWave | WAVE_2 |
| HistoricalStatePlan | 184:S1/H1, 208:S2/H2, 214:S4/H3, 219:S3/H3 |
| SupportedScenarios / TimePoints | 184, 208, 214, 219 |
| ReferenceReadiness | MOSTLY_READY |
| Blockers | DPB-006 |
| RecommendedDevelopmentScope | Urban|Military|Naval|Logistics|HistoricalEvent |
...
| Field | Reference |
|---|---|
| CityDevelopmentPack | `Docs/HISTORICAL_WORLD_REFERENCE/CITY_DEVELOPMENT_PACKS/HEFEI/` |
...
| FacilityReference | `HEFEI/CITY_DEVELOPMENT_DATA.xlsx#05_FACILITIES` |
...
- Wave：`WAVE_2`（未改变）
- Pack：`Docs/HISTORICAL_WORLD_REFERENCE/PLACE_FULL_DEVELOPMENT_REFERENCE_PACKS/PACKS/PLACE_HAN140_YANGZHOU_JIUJIANG_HEFEI`
