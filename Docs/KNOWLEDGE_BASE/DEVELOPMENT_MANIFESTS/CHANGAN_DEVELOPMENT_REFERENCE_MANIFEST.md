# 长安 Development Reference Manifest

## Document Governance

- Purpose：为长安后续开发提供唯一资料入口。
- Authority：L2 Current Development Input Manifest
- Covers：长安的Canonical、历史、人口、人物、宗族、设施、交通、军事与实现输入。
...
| HistoricalReferenceDocs | `Docs/HISTORICAL_WORLD_REFERENCE/DEEPENING_V1/04_CORE_SETTLEMENTS/P0_长安_place_han140_sili_jingzhao_changan/00_Master.md` + `Docs/HISTORICAL_WORLD_REFERENCE/FAMILY_SPATIAL_CONSOLIDATION_V1/` |
