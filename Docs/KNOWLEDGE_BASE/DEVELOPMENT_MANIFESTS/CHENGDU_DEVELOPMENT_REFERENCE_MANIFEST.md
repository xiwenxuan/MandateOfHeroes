# 成都 Development Reference Manifest

## Document Governance

- Purpose：为成都后续开发提供唯一资料入口。
- Authority：L2 Current Development Input Manifest
- Covers：成都的Canonical、历史、人口、人物、宗族、设施、交通、军事与实现输入。
...
| HistoricalReferenceDocs | `Docs/HISTORICAL_WORLD_REFERENCE/DEEPENING_V1/04_CORE_SETTLEMENTS/P0_成都_place_han140_yizhou_shu_chengdu/00_Master.md` + `Docs/HISTORICAL_WORLD_REFERENCE/FAMILY_SPATIAL_CONSOLIDATION_V1/` |
