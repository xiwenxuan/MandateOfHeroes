...
| Field | Frozen value |
|---|---|
| CanonicalPlaceId | `place.han140.jingzhou.nan.jiangling` |
| DevelopmentDepth | D4 |
| DevelopmentPriority | P1 |
| RecommendedWave | WAVE_2 |
| HistoricalStatePlan | 184:S2/H2, 208:S4/H4, 219:S3/H3, 222:S3/H3 |
| SupportedScenarios / TimePoints | 184, 208, 219, 222 |
| ReferenceReadiness | MOSTLY_READY |
| Blockers | DPB-011 |
| RecommendedDevelopmentScope | Urban|Administrative|Trade|Military|Naval|Logistics|HistoricalEvent |
...
| Field | Reference |
|---|---|
| CityDevelopmentPack | `Docs/HISTORICAL_WORLD_REFERENCE/CITY_DEVELOPMENT_PACKS/JIANGLING/` |
...
| FacilityReference | `JIANGLING/CITY_DEVELOPMENT_DATA.xlsx#05_FACILITIES` |
...
- Wave：`WAVE_2`（未改变）
- Pack：`Docs/HISTORICAL_WORLD_REFERENCE/PLACE_FULL_DEVELOPMENT_REFERENCE_PACKS/PACKS/PLACE_HAN140_JINGZHOU_NAN_JIANGLING`
