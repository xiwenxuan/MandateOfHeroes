# 阳平关 Development Reference Manifest

## Document Governance

- Purpose：为阳平关后续开发提供唯一资料入口。
...
| Field | Frozen value |
|---|---|
| CanonicalPlaceId | `geo.site.yangping` |
| DevelopmentDepth | D4 |
| DevelopmentPriority | P1 |
| RecommendedWave | WAVE_2 |
| HistoricalStatePlan | 184:S1/H1, 214:S2/H2, 219:S4/H4, 227:S3/H3 |
...
- Wave：`WAVE_2`（未改变）
- Pack：`Docs/HISTORICAL_WORLD_REFERENCE/PLACE_FULL_DEVELOPMENT_REFERENCE_PACKS/PACKS/GEO_SITE_YANGPING`
