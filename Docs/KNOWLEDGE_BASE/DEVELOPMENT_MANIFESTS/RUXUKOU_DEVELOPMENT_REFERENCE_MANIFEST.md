# 濡须口 Development Reference Manifest

## Document Governance

- Purpose：为濡须口后续开发提供唯一资料入口。
...
| Field | Frozen value |
|---|---|
| CanonicalPlaceId | `geo.site.ruxukou` |
| DevelopmentDepth | D4 |
| DevelopmentPriority | P1 |
| RecommendedWave | WAVE_2 |
| HistoricalStatePlan | 184:S1/H1, 214:S4/H3, 219:S3/H3 |
| SupportedScenarios / TimePoints | 184, 214, 219 |
| ReferenceReadiness | RESEARCH_REQUIRED |
| Blockers | DPB-014 |
| RecommendedDevelopmentScope | Naval|Military|Logistics|HistoricalEvent |
...
- Wave：`WAVE_2`（未改变）
- Pack：`Docs/HISTORICAL_WORLD_REFERENCE/PLACE_FULL_DEVELOPMENT_REFERENCE_PACKS/PACKS/GEO_SITE_RUXUKOU`
