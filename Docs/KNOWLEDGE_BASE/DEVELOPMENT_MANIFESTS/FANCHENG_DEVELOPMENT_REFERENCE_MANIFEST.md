# 樊城 Development Reference Manifest

## Document Governance

- Purpose：为樊城后续开发提供唯一资料入口。
...
| Field | Frozen value |
|---|---|
| CanonicalPlaceId | `geo.site.fancheng` |
| DevelopmentDepth | D4 |
| DevelopmentPriority | P1 |
| RecommendedWave | WAVE_1 |
| HistoricalStatePlan | 184:S1/H1, 208:S2/H2, 219:S4/H4 |
| SupportedScenarios / TimePoints | 184, 208, 219 |
| ReferenceReadiness | RESEARCH_REQUIRED |
| Blockers | DPB-016 |
| RecommendedDevelopmentScope | Military|River|Urban|HistoricalEvent |
...
- Wave：`WAVE_1`（未改变）
- Pack：`Docs/HISTORICAL_WORLD_REFERENCE/PLACE_FULL_DEVELOPMENT_REFERENCE_PACKS/PACKS/GEO_SITE_FANCHENG`
