# 邺 Development Reference Manifest

## Document Governance

- Purpose：为邺后续开发提供唯一资料入口。
- Authority：L2 Current Development Input Manifest
- Covers：邺的Canonical、历史、人口、人物、宗族、设施、交通、军事与实现输入。
...
| HistoricalReferenceDocs | `Docs/HISTORICAL_WORLD_REFERENCE/DEEPENING_V1/04_CORE_SETTLEMENTS/P0_邺_place_han140_jizhou_wei_ye/00_Master.md` + `Docs/HISTORICAL_WORLD_REFERENCE/FAMILY_SPATIAL_CONSOLIDATION_V1/` |
...
| Field | Frozen value |
|---|---|
| CanonicalPlaceId | `place.han140.jizhou.wei.ye` |
| DevelopmentDepth | D4 |
| DevelopmentPriority | P1 |
| RecommendedWave | WAVE_1 |
| HistoricalStatePlan | 184:S2/H2, 189:S2/H2, 200:S4/H3, 207:S3/H3, 220:S4/H4 |
| SupportedScenarios / TimePoints | 184, 189, 200, 207, 220 |
...
| Field | Reference |
|---|---|
| CityDevelopmentPack | `Docs/HISTORICAL_WORLD_REFERENCE/CITY_DEVELOPMENT_PACKS/YE/` |
...
| FacilityReference | `YE/CITY_DEVELOPMENT_DATA.xlsx#05_FACILITIES` |
...
- Wave：`WAVE_1`（未改变）
- Pack：`Docs/HISTORICAL_WORLD_REFERENCE/PLACE_FULL_DEVELOPMENT_REFERENCE_PACKS/PACKS/PLACE_HAN140_JIZHOU_WEI_YE`
