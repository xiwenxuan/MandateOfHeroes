# 建业 Development Reference Manifest

## Document Governance

- Purpose：为建业后续开发提供唯一资料入口。
- Authority：L2 Current Development Input Manifest
- Covers：建业的Canonical、历史、人口、人物、宗族、设施、交通、军事与实现输入。
...
| HistoricalReferenceDocs | `Docs/HISTORICAL_WORLD_REFERENCE/DEEPENING_V1/04_CORE_SETTLEMENTS/P0_建业_place_han140_yangzhou_danyang_moling/00_Master.md` + `Docs/HISTORICAL_WORLD_REFERENCE/FAMILY_SPATIAL_CONSOLIDATION_V1/` |
...
| Field | Frozen value |
|---|---|
| CanonicalPlaceId | `place.han140.yangzhou.danyang.moling` |
| DevelopmentDepth | D4 |
| DevelopmentPriority | P1 |
| RecommendedWave | WAVE_2 |
| HistoricalStatePlan | 184:S2/H2, 194:S2/H2, 212:S4/H4, 229:S4/H3 |
| SupportedScenarios / TimePoints | 184, 194, 212, 229 |
| ReferenceReadiness | MOSTLY_READY |
| Blockers | DPB-007 |
| RecommendedDevelopmentScope | Urban|Administrative|Trade|Naval|Political|HistoricalEvent |
...
| Field | Reference |
|---|---|
| CityDevelopmentPack | `Docs/HISTORICAL_WORLD_REFERENCE/CITY_DEVELOPMENT_PACKS/JIANYE/` |
...
| FacilityReference | `JIANYE/CITY_DEVELOPMENT_DATA.xlsx#05_FACILITIES` |
| PersonCoverage | 10 stable PersonId city-slice records |
| FamilyCoverage | 5 Clan/Branch slice records; no automatic FamilyCenter |
...
- Wave：`WAVE_2`（未改变）
- Pack：`Docs/HISTORICAL_WORLD_REFERENCE/PLACE_FULL_DEVELOPMENT_REFERENCE_PACKS/PACKS/PLACE_HAN140_YANGZHOU_DANYANG_MOLING`
